    ...
    public partial class EOForm : Form
    {
                ...
                case 2:
                    ...
                    */
                    ...
                    if (grpEOType.Enabled)
                    {
                        ...
                        {
                            MainForm.Guna2Msg(this, "오류", "'EO 구분' 체크 오류 발생", true);
                            Close();
                        }
                    }
                    else
        ...
        public static void ModelSelect(string _data, int _type)
        {
            try
            {
                ...
                {
                    MainForm.Guna2Msg(new EOForm(), "오류", "치명적인 오류");
                    return;
                }
        ...
        private void dataGridView1_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            if (dataGridView1.Rows.Count > 0 && dataGridView1.CurrentCell.ColumnIndex != 0)
            {
                ...
                {
                    MainForm.Guna2Msg(this, "오류", "다른 차종은 선택할 수 없습니다");
                    return;
                }
        ...
        private void btnProductAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                MainForm.Guna2Msg(this, "오류", "'작업변경지시서' 첨부해야 합니다");
                return;
            }
            ...
            {
                MainForm.Guna2Msg(this, "오류", "차종을 입력해주세요 [2글자 이상]");
                return;
            }
               ...
               )
            {
                ...
                MainForm.Guna2Msg(this, "오류", "작업변경지시서 차종과 입력한 차종이 일치 하지 않습니다");
            ...
            {
                MainForm.Guna2Msg(this, "오류", "'초도품' 또는 '샘플'을 선택해야 합니다");
                return;
            }
            ...
            {
                MainForm.Guna2Msg(this, "오류", "고객사 EO 번호는 8자리 입니다");
                return;
            }
            else if (MainForm.IsSpaceCheck(txtCustomerEO.Text))
            {
                MainForm.Guna2Msg(this, "오류", "고객사 EO 번호에 띄어쓰기가 있습니다");
                return;
            }
            ...
            {
                MainForm.Guna2Msg(this, "오류", "고객사 EO 번호의 첫 글자는 H, K, R로 시작해야합니다");
                return;
            }
            ...
            if (!chkDualEO.Checked)
            {
                ...
                {
                    MainForm.Guna2Msg(this, "오류", "모비스 EO 번호를 입력해주세요 [1번 입력칸]");
                    return;
                }
                // 8자리 입력 확인
                else if (!EONumberContentsCheck(txtMobisEO1.Text) && txtMobisEO1.Text.Length != 8)
                {
                    MainForm.Guna2Msg(this, "오류", "모비스 EO 번호는 8자리 입니다 [1번 입력칸]");
                    return;
                }
                // 공백 확인
                else if (MainForm.IsSpaceCheck(txtMobisEO1.Text))
                {
                    MainForm.Guna2Msg(this, "오류", "모비스 EO 번호에 띄어쓰기가 있습니다");
                    return;
                }
                else if (EODuplicationCheck(txtCustomerEO.Text, "customer_eo_number"))
                {
                    ...
                    {
                        //MainForm.Guna2Msg(this, "오류", "고객사 EO 번호 : " + txtCustomerEO.Text + "\n\n이미 등록되어 있습니다");
                        return;
                    }
                }
                if (EODuplicationCheck(txtMobisEO1.Text, "mobis_eo_number") && !mobisNumber.Equals("4M"))
                {
                    MainForm.Guna2Msg(this, "오류", "모비스 EO 번호 : " + mobisNumber + "\n\n이미 등록되어 있습니다");
                    return;
                }
                /*
                // 출하지 확인
                else if (EONumberShipmentCheck(txtMobisEO1.Text))
                {
                    if (!shipmentType.Equals(string.Empty))
                    {
                        ...
                        if (mobisNumber == "-")
                        {
                            MainForm.Guna2Msg(this, "오류", "모비스 EO 번호 [" + mobisNumber + "](이)가 EO 내용 [" + txtEOContents.Text + "] (으)로 등록되어 있습니다");
                        }
                        else
                        {
                            MainForm.Guna2Msg(this, "오류", "모비스 EO 번호 [" + mobisNumber + "](이)가 출하지 [" + shipmentType + "](으)로 등록되어 있습니다");
                        }
                    }
                    // D-오디오 SUB
                    else
                    {
                        MainForm.Guna2Msg(this, "오류", "모비스 EO가 등록되어 있습니다");
                    }
                    return;
                }
                */
                ...
                {
                    MainForm.Guna2Msg(this, "오류", "모비스 EO 내용이 중복입니다");
                    return;
                }
            }
            // 모비스 EO - 2 체크
            else
            {
                ...
                {
                    MainForm.Guna2Msg(this, "오류", "고객사 EO 번호에 띄어쓰기가 있습니다 [1번 입력칸]");
                    return;
                }
                ...
                {
                    MainForm.Guna2Msg(this, "오류", "모비스 EO 번호를 입력해주세요 [2번 입력칸]");
                    return;
                }
                // 8자리 입력 확인
                else if (txtMobisEO2.TextLength != 8)
                {
                    MainForm.Guna2Msg(this, "오류", "모비스 EO 번호는 8자리 입니다 [2번 입력칸]");
                    return;
                }
                else if (MainForm.IsSpaceCheck(txtMobisEO2.Text))
                {
                    MainForm.Guna2Msg(this, "오류", "모비스 EO 번호에 띄어쓰기가 있습니다 [2번 입력칸]");
                    return;
                }
                // 2개가 같은지 검사
                else if (txtMobisEO1.Text == txtMobisEO2.Text)
                {
                    MainForm.Guna2Msg(this, "오류", "모비스 EO 번호가 똑같습니다. [1번, 2번 입력칸]");
                    return;
                }
                else if (EODuplicationCheck(txtCustomerEO.Text, "customer_eo_number"))
                {
                ...
                else if (EODuplicationCheck(mobisNumber, "mobis_eo_number") && !mobisNumber.Equals("4M"))
                {
                    MainForm.Guna2Msg(this, "오류", "모비스 EO 번호 : " + mobisNumber + "\n\n이미 등록되어 있습니다");
                    return;
                }
                ...
                {
                    MainForm.Guna2Msg(this, "오류", "모비스 EO 번호가 중복입니다");
                    return;
                }
                */
                else if (EODuplicationCheck(txtEOContents.Text, "eo_contents") && (txtMobisEO1.Text.Equals("-") || txtMobisEO1.Text.Equals("4M")))
            ...
            {
                MainForm.Guna2Msg(this, "오류", "EO 내용을 입력해주세요");
                return;
            }
            else if (txtEOContents.Lines.Length > 3)
            {
                MainForm.Guna2Msg(this, "오류", "EO 내용은 3줄 이하로 입력해주세요");
                return;
            }
        ...
        private void btnProductDelete_Click(object sender, EventArgs e)
        {
            ...
            if (count > 0)
            {
                MainForm.Guna2Msg(this, "오류", count.ToString() + "건 삭제되었습니다");
        ...
        private void btnProductSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                MainForm.Guna2Msg(this, "오류", "라인을 선택해주세요");
            }
        }
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                // 2021.03.03
                // 오류 수정
                stickerColor = stickerColor == "ScrollBar" ? string.Empty : stickerColor;
        ...
        private void dataGridView1_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            if (dataGridView1.Rows.Count > 0)
            {
                ...
                else if (dataGridView1.Rows[dataGridView1.CurrentRow.Index].Cells[11].Value.ToString() == "제외")
                {
                    rdoException.Checked = true;
                }
            }
